  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-[#0D0C1A]/90 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 lg:px-8">
        <Link href="/landing" aria-label="Keeply home">
          <KeeplyLogo size={28} wordmarkColor="#FFFFFF" />
        </Link>

        <nav className="hidden items-center gap-7 lg:flex">
          <Link href={DOCS_URL} className="text-sm font-medium text-slate-400 transition-colors hover:text-white">
            Documentação
          </Link>
          <Link href="/roadmap" className="text-sm font-medium text-slate-400 transition-colors hover:text-white">
            Roadmap
          </Link>
          <Link href={DOWNLOAD_URL} className="text-sm font-medium text-slate-400 transition-colors hover:text-white">
            Download
          </Link>
        </nav>
        ...
        <div className="p-5">
          ...
          <div className="overflow-hidden rounded-lg border border-white/10 bg-white/5">
            <div className="flex items-center justify-between border-b border-white/10 px-4 py-2.5">
              ...
              <span className="cursor-pointer text-[10px] text-[#7B61FF] hover:underline">Ver todos</span>
            </div>
                ...
                >
                  <div
                    className={`mb-3 text-[10px] font-bold uppercase tracking-widest ${
                      step.highlight ? "text-[#7B61FF]" : "text-[#6B6993]"
                    }`}
                  >
...
const FOOTER_COLS = [
  ...
  },
  {
    ...
    links: [
      { label: "Documentação", href: DOCS_URL, external: false },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Contato", href: "mailto:Ti@grupo4us.com", external: false },
    ],
  },
];
