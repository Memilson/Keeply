...
Write-Host "Removendo arquivos de configuracao, estado e bancos do agente..." -ForegroundColor Yellow
...
Write-Host "Criando usuario de teste (keeply@keeply.com)..." -ForegroundColor Yellow
$body = @{
    name = "Keeply Test"
